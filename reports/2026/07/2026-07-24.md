# JWST × Galaxy arXiv Daily — 2026-07-24

发现 **4** 篇未推送过的相关论文。

## 1. Outflows in the Early Universe: Neutral gas Absorption in Galaxies at z &gt; 3 from low-resolution JWST Spectroscopy

- **相关度：** 11
- **匹配词：** JWST, NIRSpec, galaxies, star formation, stellar mass, SED fitting, Dusty star-forming galaxies
- **作者：** Matteo Sapori, Sirio Belli, Letizia Bugiani, Amir H. Khoram, Caterina Liboni, Gabriel Maheson, Gabriel Brammer, Rebecca Davies, Pratika Dayal, Anna de Graaff, Joel Leja, Rohan Naidu, Pascal Oesch, Stefano Sotira, Sandro Tacchella, Bingjie Wang, Katherine E. Whitaker
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-22
- **链接：** [摘要](https://arxiv.org/abs/2607.20606) · [PDF](https://arxiv.org/pdf/2607.20606v1)
...
- **相关度：** 10
- **匹配词：** JWST, galaxies, cosmic dawn, star formation
- **作者：** Hovav Lazare, Sarah Libanore, Eleonora Vanzan, Julian B. Muñoz, Ely D. Kovetz
- **分类：** astro-ph.CO, astro-ph.GA
- **首次提交：** 2026-07-22
- **链接：** [摘要](https://arxiv.org/abs/2607.20651) · [PDF](https://arxiv.org/pdf/2607.20651v1)
...
## 3. MIGHTEE: The Host-Galaxy Associated Catalogue of the Radio Sources in MIGHTEE Continuum Data Release 1

- **相关度：** 9
- **匹配词：** COSMOS, galaxy, galaxies, extragalactic, star formation, stellar mass, AGN
- **作者：** C. L. Hale, J. Hamlett, I. H. Whittam, M. J. Jarvis, M. J. Hardcastle, S. L. Jung, N. Stylianou, R. G. Varadaraj, M. Vaccari, L. Barchiesi, P. N. Best, K. K. L. Charlton, E. Malefahlo, E. Moravec, J. P. Moss, M. Rakototafika, T. F. Rarivoarinoro, F. Sinigaglia, M. N. Tudorache, S. I. Loubser, L. Heino, A. Saintonge, A. Mazumder, N. Netshiavha, D. J. B. Smith, L. Verdes-Montenegro, J. Delhaize, H. Pan, F. Pozzi, Z. Randriamanakoto, L. Stockenstroom, A. A. Vărăşteanu, E. Vardoulaki, W. L. Williams, R. A. A. Bowler, L. Marchetti, A. Matthews
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-23
- **链接：** [摘要](https://arxiv.org/abs/2607.21122) · [PDF](https://arxiv.org/pdf/2607.21122v1)
...
## 4. A dust-free hierarchically nested supermassive-star model for James Webb Space Telescope Little Red Dots

- **相关度：** 5
- **匹配词：** James Webb Space Telescope, high redshift
- **作者：** Pau Amaro Seoane
- **分类：** astro-ph.SR, astro-ph.GA, astro-ph.HE
- **首次提交：** 2026-07-22
- **链接：** [摘要](https://arxiv.org/abs/2607.20617) · [PDF](https://arxiv.org/pdf/2607.20617v1)
