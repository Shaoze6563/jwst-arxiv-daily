# JWST × Galaxy arXiv Daily — 2026-07-14

发现 **6** 篇未推送过的相关论文。

## 1. Gravitationally Lensed View of DSFG-1 in PLCK G165.7+67.0: Strong Dust Emission and Spatially Resolved Stellar Population Analysis with JWST and SMA

- **相关度：** 13
- **匹配词：** JWST, NIRCam, galaxy, galaxies, stellar population, DSFG, star formation, stellar mass, dust attenuation, Dusty star-forming galaxy
- **作者：** Zhiyu Yan, Daizhong Liu, Y. Sophia Dai, Patrick S. Kamieneski, Pierre Cox, Brenda L. Frye, Qinghua Tan, Fengwei Xu, Yixiao Liu, Ke Wang
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-13
- **链接：** [摘要](https://arxiv.org/abs/2607.11049) · [PDF](https://arxiv.org/pdf/2607.11049v1)
...
- **相关度：** 11
- **匹配词：** JWST, NIRCam, galaxy, galaxies, protocluster, star formation, stellar mass, Dusty star-forming galaxies
- **作者：** J. Nadolny, J. M. Pérez-Martínez, H. Dannerbauer, B. Haussler, M. Huertas-Company, K. Daikuhara, T. Kodama, Y. Koyama, A. Naufal, P. G. Pérez-González, Y. H. Zhang
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-13
- **链接：** [摘要](https://arxiv.org/abs/2607.11448) · [PDF](https://arxiv.org/pdf/2607.11448v1)
...
## 3. JWST NIRCam and MIRI Reveal the Dust-Producing AGB Population of NGC 6822

- **相关度：** 9
- **匹配词：** JWST, NIRCam, MIRI, galaxy, star formation, spectral energy distribution, metallicity
- **作者：** Conor Nally, Olivia C. Jones, Laura Lenkić, Annette M. N. Ferguson, Nolan Habel, Alec S. Hirschauer, Margaret Meixner, P. J. Kavanagh, Martha L. Boyer, Omnarayani Nayak, B. Sargent, P. Scicluna
- **分类：** astro-ph.GA, astro-ph.SR
- **首次提交：** 2026-07-13
- **链接：** [摘要](https://arxiv.org/abs/2607.11682) · [PDF](https://arxiv.org/pdf/2607.11682v1)
...
## 4. Do we understand the star formation history of the universe?

- **相关度：** 9
- **匹配词：** James Webb Space Telescope, galaxy, galaxies, star formation, stellar mass, SED fitting, quiescent
- **作者：** Sahil Hegde, Steven R. Furlanetto, Smadar Naoz
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-10
- **链接：** [摘要](https://arxiv.org/abs/2607.09848) · [PDF](https://arxiv.org/pdf/2607.09848v1)
...
## 5. Spectral Energy Distributions of Globular Clusters in VV191a

- **相关度：** 7
- **匹配词：** JWST, NIRCam, galaxy, galaxies, spectral energy distribution, SED fitting, dust attenuation, metallicity
- **作者：** Ashton Cardona, Timothy Carleton, Jessica Berkheimer, Rogier A. Windhorst, Seth Cohen, Rolf Jansen, Anton M. Koekemoer, Gibson Bowling, Patrick Kamieneski, Jakob Perivolotis, Tyler Hinrichs, Christopher Willmer
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-11
- **链接：** [摘要](https://arxiv.org/abs/2607.10352) · [PDF](https://arxiv.org/pdf/2607.10352v1)
...
- **相关度：** 7
- **匹配词：** JWST, NIRSpec, galaxy, galaxies, star formation, emission line, Halpha, dust attenuation, metallicity
- **作者：** Anand Utsav Kapoor, Maarten Baes, Aaron Smith, Arno Lauwers, Andrea Gebek, Peter Camps, Sven De Rijcke, Arjen van der Wel, Kosei Matsumoto, William McClymont
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-10
- **链接：** [摘要](https://arxiv.org/abs/2607.09961) · [PDF](https://arxiv.org/pdf/2607.09961v1)
