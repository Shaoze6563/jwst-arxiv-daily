# JWST × Galaxy arXiv Daily — 2026-07-23

发现 **7** 篇未推送过的相关论文。

## 1. Nebular continuum in high-redshift galaxies with JWST

- **相关度：** 12
- **匹配词：** JWST, galaxies, galaxy, high redshift, stellar population
- **作者：** Henrique Miranda, Ciro Pappalardo, José Afonso, Polychronis Papaderos, Rodrigo Carvajal
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-22
- **链接：** [摘要](https://arxiv.org/abs/2607.19970) · [PDF](https://arxiv.org/pdf/2607.19970v1)
...
## 2. Mid-Infrared Colors Vary with Galactic Environment: Contrasting Star-Forming Disks, Young Centers, and Quiescent Star-Formation Deserts

- **相关度：** 10
- **匹配词：** JWST, NIRCam, MIRI, galaxies, star formation, quiescent
- **作者：** Debosmita Pathak, Karin M. Sandstrom, Adam K. Leroy, Ryan Chown, Daniel A. Dale, Hannah B. Koziol, Mansi Padave, Jessica Sutter, Thomas G. Williams, Dalya Baron, Alberto D. Bolatto, Mederic Boquien, Oleg V. Egorov, Eric Emsellem, Simon C. O. Glover, Ralf S. Klessen, Eva Schinnerer, Todd A. Thompson, Francesco Belfiore, Frank Bigiel, Enrico Congiu, Ivan Gerasimov, Jay Gonzalez Lobos, Annie Hughes, Laura A. Lopez, Justus Neumann, Elias K. Oakes, Hsi-An Pan, Erik Rosolowsky, Sumit K. Sarbadhicary
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19512) · [PDF](https://arxiv.org/pdf/2607.19512v1)
...
## 3. Rapid growth in a dual AGN during a gas-rich merger at z~4.5

- **相关度：** 8
- **匹配词：** JWST, NIRSpec, galaxy, galaxies, AGN, high redshift
- **作者：** Hyewon Suh, Roberto Decarli, Emanuele Paolo Farina, Julia Scharwächter, Mar Mezcua, Giorgio Lanzuisi, Federica Loiacono, Brian C. Lemaux, Sukyoung K. Yi, Stefano Marchesi, Marta Volonteri, Günther Hasinger, Francesca Civano, Anniek Gloudemans, Ena Choi, Yeonwoo Nam, Adi Foord, Silvia Onorato
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19491) · [PDF](https://arxiv.org/pdf/2607.19491v1)
...
- **相关度：** 7
- **匹配词：** JWST, James Webb Space Telescope, high-z, high redshift, spectral energy distribution
- **作者：** Elena Tomasetti, Martin Millon, Licia Verde, Frédéric Courbin, Raul Jimenez, Michele Moresco, Carmela Lardo, Andrea Cimatti
- **分类：** astro-ph.CO, astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19472) · [PDF](https://arxiv.org/pdf/2607.19472v1)
...
## 5. The first dusty galaxies across $6 \lesssim z \lesssim 14$: Blue monsters, red monsters, and the bimodality of dust content in early galaxies

- **相关度：** 7
- **匹配词：** JWST, galaxies, high redshift
- **作者：** Sergio Martínez-González, Casiana Muñoz-Tuñón, Santiago Jiménez
- **分类：** astro-ph.GA, astro-ph.CO
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19471) · [PDF](https://arxiv.org/pdf/2607.19471v1)
...
## 6. Clarifying Dead Quasars and Downsizing through the Evolution of Star-Forming Galaxies and Active Galactic Nuclei

- **相关度：** 6
- **匹配词：** JWST, James Webb Space Telescope, NIRSpec, MIRI, galaxies
- **作者：** Shingo Sumie
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-20
- **链接：** [摘要](https://arxiv.org/abs/2607.19428) · [PDF](https://arxiv.org/pdf/2607.19428v1)
...
- **相关度：** 5
- **匹配词：** JWST, stellar mass
- **作者：** Joe Williams, Sebastiaan Krijt, Joanna Drążkowska, Tim Lichtenberg
- **分类：** astro-ph.EP, astro-ph.SR
- **首次提交：** 2026-07-22
- **链接：** [摘要](https://arxiv.org/abs/2607.20271) · [PDF](https://arxiv.org/pdf/2607.20271v1)
