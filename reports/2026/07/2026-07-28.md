# JWST × Galaxy arXiv Daily — 2026-07-28
...
- **相关度：** 11
- **匹配词：** NIRCam, JWST, JADES, galaxies, galaxy, star formation, stellar mass, stellar population, emission line, SED fitting, dust attenuation, metallicity
- **作者：** Yongda Zhu, Marcia J. Rieke, Courtney Carreira, Yang Sun, Zhiyuan Ji, Jianwei Lyu, Christina C. Williams, Stacey Alberts, Feng Yuan, Yuxuan Zou, Yurina Nakazato, Andrew J. Bunker, Sandro Tacchella, Fengwu Sun, George H. Rieke, Eiichi Egami, Jacopo Chevallard, Kevin Hainline, Zheng Ma, Pablo G. Pérez-González, Pierluigi Rinaldi, Bruno Rodríguez Del Pino, Tristen Shields, Meredith Stone, Christopher N. A. Willmer, Zihao Wu, Minghao Yue, Junyu Zhang
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-25
- **链接：** [摘要](https://arxiv.org/abs/2607.23020) · [PDF](https://arxiv.org/pdf/2607.23020v1)
...
## 2. Reionization driven by the few: the ionizing budget of galaxies at z=5-10 from JWST/NIRSpec

- **相关度：** 11
- **匹配词：** JWST, NIRSpec, galaxies, galaxy, reionization
- **作者：** Emma Giovinazzo, Pascal A. Oesch, Anne Verhamme, Romain A. Meyer, Callum Witten, John Chisholm, Rui Marques-Chaves, Charlotte Simmonds
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-24
- **链接：** [摘要](https://arxiv.org/abs/2607.22834) · [PDF](https://arxiv.org/pdf/2607.22834v1)
...
## 3. HETDEX: Star Formation Stochasticity Diagram of Lyman Alpha Emitting Galaxies at Cosmic Noon Confirms Three Archetypes

- **相关度：** 10
- **匹配词：** COSMOS, galaxies, star formation, stellar mass
- **作者：** Nicole Firestone, Eric Gawiser, Kartheik G. Iyer, Charlotte Olsen, Antara Basu-Zych, Adam Broussard, Peter Kurczynski, Kyoung-Soo Lee, Erin Mentuch Cooper, Robin Ciardullo, Daniel J. Farrow, Steven L. Finkelstein, Caryl Gronwall, Ho Seong Hwang, Byeongha Moon, Shun Saito, Donald P. Schneider
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-25
- **链接：** [摘要](https://arxiv.org/abs/2607.23062) · [PDF](https://arxiv.org/pdf/2607.23062v1)
...
## 4. Unsupervised selection and characterisation of Little Red Dots in JWST surveys with manifold learning

- **相关度：** 7
- **匹配词：** JWST, NIRSpec, high redshift, AGN, morphology
- **作者：** Michele Ginolfi, Filippo Mannucci, Alessandro Marconi, Francesco D&#x27;Eugenio, Giacomo Venturi, Francesco Belfiore, Giovanni Cresci, Caterina Bracci, Stefano Carniani, Alessandra Cozzi, Roberto Maiolino, Guido Risaliti
- **分类：** astro-ph.GA, astro-ph.IM
- **首次提交：** 2026-07-24
- **链接：** [摘要](https://arxiv.org/abs/2607.22835) · [PDF](https://arxiv.org/pdf/2607.22835v1)
...
## 5. JWST/NIRCam Imaging of Young Stellar Objects. IV. Detailed Imaging of the Protoplanetary Disk around TW Hya

- **相关度：** 5
- **匹配词：** JWST, NIRCam, morphology
- **作者：** Yu-Chia Lin, Jarron Leisenring, Schuyler G. Wolff, Justin Hom, Kellen Lawson, Ewan S. Douglas, George Rieke, Gabriele Cugno, John Debes, Ruobing Dong, Doug Johnstone, Camryn Mullin, Taylor L. Tobin, Kevin R. Wagner, Thomas P. Greene, Michael R. Meyer, Marcia Rieke
- **分类：** astro-ph.EP, astro-ph.SR
- **首次提交：** 2026-07-27
- **链接：** [摘要](https://arxiv.org/abs/2607.23992) · [PDF](https://arxiv.org/pdf/2607.23992v1)
...
## 6. A quasar hatching from a buried red phase at z = 3.7

- **相关度：** 5
- **匹配词：** JWST, NIRCam, NIRSpec, MIRI, JADES, galaxy, dust attenuation
- **作者：** Zheng Ma, Yongda Zhu, Zhiyuan Ji, Eiichi Egami, Marcia J. Rieke, Xiaohui Fan, Jianwei Lyu, George H. Rieke, Fengwu Sun, Yang Sun, George D. Becker, Andrew J. Bunker, Francesco D&#x27;Eugenio, Xiangyu Jin, Ignas Juodžbalis, Weizhe Liu, Roberto Maiolino, Pierluigi Rinaldi, Feige Wang, Christopher N. A. Willmer, Yunjing Wu, Jinyi Yang, Junyu Zhang, Peixin Zhu
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-25
- **链接：** [摘要](https://arxiv.org/abs/2607.22966) · [PDF](https://arxiv.org/pdf/2607.22966v1)
