# JWST × Galaxy arXiv Daily — 2026-07-13
...
- **相关度：** 13
- **匹配词：** JWST, galaxy, high-z, star formation, stellar mass, metallicity
- **作者：** Cheonsu Kang, Taysun Kimm, Daniel Han, Maxime Rey, Fred Thompson, Martin P. Rey, Harley Katz
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-09
- **链接：** [摘要](https://arxiv.org/abs/2607.08846) · [PDF](https://arxiv.org/pdf/2607.08846v1)
...
## 3. What becomes of JWST/NIRCam-selected high-redshift massive galaxies?

- **相关度：** 11
- **匹配词：** JWST, NIRCam, galaxies, galaxy, high redshift
- **作者：** Devontae C. Baxter, Alison L. Coil, Ethan O Nadler, Xuejian Shen, Mark Vogelsberger
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-09
- **链接：** [摘要](https://arxiv.org/abs/2607.08820) · [PDF](https://arxiv.org/pdf/2607.08820v1)
...
## 4. A big step forward with SHARP: spatially resolved stellar population properties in passive galaxies at z &gt; 1.5

- **相关度：** 11
- **匹配词：** COSMOS, COSMOS-Web, galaxies, galaxy, stellar population, stellar mass, quiescent, metallicity
- **作者：** A. Gargiulo, C. Mancini, F. R. Ditrani, S. Bisogni, P. Franzetti, G. Vietri, A. Gallazzi, M. Longhetti, S. Zibetti
- **分类：** astro-ph.GA
- **首次提交：** 2026-06-30
- **链接：** [摘要](https://arxiv.org/abs/2606.31628) · [PDF](https://arxiv.org/pdf/2606.31628v1)
...
## 5. Spatial decomposition of Little Red Dots with JWST/NIRSpec IFU into broad-line red cores and narrow-line blue host galaxies

- **相关度：** 9
- **匹配词：** JWST, NIRSpec, James Webb Space Telescope, galaxies, galaxy, emission line
- **作者：** Yuzo Ishikawa, Anna-Christina Eilers, Rohan P. Naidu, Jorryt Matthee, Rongmon Bordoloi, John Chisholm, Jenny E. Greene, Yilun Ma, Pascal A. Oesch, Wendy Q. Sun, Alberto Torralba, John R. Weaver, Stijn Wuyts, Mengyuan Xiao
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-10
- **链接：** [摘要](https://arxiv.org/abs/2607.09647) · [PDF](https://arxiv.org/pdf/2607.09647v1)
...
## 6. A MIGHTEE robust measurement of the star formation rate-radio correlation

- **相关度：** 9
- **匹配词：** COSMOS, galaxies, star formation, stellar mass, AGN, spectral energy distribution
- **作者：** Charlotte L. Jackson, Matt J. Jarvis, Imogen H. Whittam, James H. Matthews, Johannes Buchner, Catherine L. Hale, Joel Hamlett, S. Lyla Jung, Mara Salvato, Daniel J. B. Smith, Natalia Stylianou, Rohan G. Varadaraj
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-03
- **链接：** [摘要](https://arxiv.org/abs/2607.03543) · [PDF](https://arxiv.org/pdf/2607.03543v1)
...
## 7. Project Hephaistos -- IV. James Webb Space Telescope Observations of Two Dyson Sphere Candidates

- **相关度：** 7
- **匹配词：** James Webb Space Telescope, JWST, MIRI, galaxy, galaxies, morphology
- **作者：** Erik Zackrisson, Arjan Bik, Anita Ali Asgar, Olivia Curtis, Jason T. Wright, Tongtian Ren, Roberto J. Assef, Andrew Blain, Alexis Brandeker, Michael A. Garrett, Uma Gorti, Andreas J. Korn, Priyatam K. Mahto, Armin Nabizadeh
- **分类：** astro-ph.GA, astro-ph.SR
- **首次提交：** 2026-07-10
- **链接：** [摘要](https://arxiv.org/abs/2607.09460) · [PDF](https://arxiv.org/pdf/2607.09460v1)
...
## 8. The VLA-COSMOS 3 GHz Large Project: Polarised source counts and catalogue

- **相关度：** 6
- **匹配词：** COSMOS, galaxy, galaxies
- **作者：** S. Ranchod, S. A. Mao, R. P. Deane, V. Smolčić, J. D. Wagenveld, M. Bondi, K. Mooley, E. Schinnerer
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-02
- **链接：** [摘要](https://arxiv.org/abs/2607.02342) · [PDF](https://arxiv.org/pdf/2607.02342v1)
...
## 9. Deep Extragalactic VIsible Legacy Survey (DEVILS): Morphologically-selected galaxy merger fractions and their direct comparison to close-pair samples

- **相关度：** 6
- **匹配词：** COSMOS, galaxy, extragalactic, galaxies
- **作者：** Melissa F. Fuentealba-Fuentes, Luke J. M. Davies, Aaron S. G. Robotham, Sabine Bellstedt, Claudia D. P. Lagos, Michael J. I. Brown, Malgorzata Siudek
- **分类：** astro-ph.GA
- **首次提交：** 2026-06-30
- **链接：** [摘要](https://arxiv.org/abs/2606.31140) · [PDF](https://arxiv.org/pdf/2606.31140v1)
