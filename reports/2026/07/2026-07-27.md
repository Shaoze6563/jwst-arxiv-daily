# JWST × Galaxy arXiv Daily — 2026-07-27

发现 **3** 篇未推送过的相关论文。

## 1. SED Fitting of the Globular Clusters in Abell 2744 at z=0.3

- **相关度：** 9
- **匹配词：** JWST, NIRCam, galaxy, SED fitting, spectral energy distribution, metallicity
- **作者：** Jinoo Kim, William E. Harris
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-23
- **链接：** [摘要](https://arxiv.org/abs/2607.21739) · [PDF](https://arxiv.org/pdf/2607.21739v1)
...
- **相关度：** 5
- **匹配词：** JWST, MIRI, stellar mass
- **作者：** Naman S. Bajaj, Ilaria Pascucci, Sylvie Cabrit, Suzan Edwards, Gabriele Cugno, Andrew D. Sellek, Joan R. Najita, Ke Zhang, Richard Alexander, Gregory J. Herczeg, Uma Gorti, Sophie C. Clark, Tracy L. Beck
- **分类：** astro-ph.EP
- **首次提交：** 2026-07-23
- **链接：** [摘要](https://arxiv.org/abs/2607.21733) · [PDF](https://arxiv.org/pdf/2607.21733v1)
...
## 3. Outflows in super-Eddington quasars drive clumpy circumgalactic medium and extended H$α$ nebulae at $z \gtrsim 6$

- **相关度：** 5
- **匹配词：** JWST, galaxy, galaxies, protocluster
- **作者：** Lucas Tortora, Tiago Costa, Debora Sijacki, Jake S. Bennett
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-23
- **链接：** [摘要](https://arxiv.org/abs/2607.21719) · [PDF](https://arxiv.org/pdf/2607.21719v1)
