# JWST × Galaxy arXiv Daily — 2026-07-22
...
- **相关度：** 9
- **匹配词：** JWST, James Webb Space Telescope, galaxies, galaxy, high redshift, star formation, spectral energy distribution
- **作者：** Seiji Toshikage, Takahiro Morishita, Masaomi Tanaka, Kazumi Kashiyama, Charlotte A. Mason, Andrew J. Bunker, Matthew J. Hayes, George Helou, Tadayuki Kodama, Kimi C. Kreilgaard, Massimo Stiavelli, Tommaso Treu
- **分类：** astro-ph.HE, astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.18972) · [PDF](https://arxiv.org/pdf/2607.18972v1)
...
- **作者：** M. V. Legnardi, F. Muratore, A. P. Milone, G. Cordoni, E. Dondoglio, L. N. Gorza, A. Bellini, F. Calura, S. Jang, H. Jerjen, A. Karakas, E. P. Lagioia, C. Li, A. Mastrobuono-Battisti, M. Tailo, E. Vesperini, E. Bortolan, A. F. Marino, S. Di Stefano
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19260) · [PDF](https://arxiv.org/pdf/2607.19260v1)
...
- **相关度：** 8
- **匹配词：** NIRSpec, JWST, AGN, high redshift
...
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-21
- **链接：** [摘要](https://arxiv.org/abs/2607.19057) · [PDF](https://arxiv.org/pdf/2607.19057v1)
...
## 4. Precise Determination of the Metallicity and C/O of WASP-39~b From a Single JWST Instrument Mode with Phase-Resolved Cross-Correlation Retrievals

- **相关度：** 7
- **匹配词：** JWST, NIRSpec, metallicity
- **作者：** Arjun B. Savel, Eliza M. -R. Kempton, Erin M. May, Matthew C. Nixon, Jegug Ih, Katherine A. Bennett, Joost P. Wardenier
- **分类：** astro-ph.EP, astro-ph.IM
- **首次提交：** 2026-07-20
- **链接：** [摘要](https://arxiv.org/abs/2607.18409) · [PDF](https://arxiv.org/pdf/2607.18409v1)
