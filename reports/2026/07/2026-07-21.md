# JWST × Galaxy arXiv Daily — 2026-07-21

发现 **2** 篇未推送过的相关论文。

## 1. A Rest-frame K-band View of Bulge Growth in Massive Dusty Star-forming Galaxies at z~2

- **相关度：** 11
- **匹配词：** JWST, NIRCam, MIRI, galaxies, Dusty star-forming galaxies, star formation, stellar mass, quiescent, dust attenuation
- **作者：** Ken-ichi Tadaki
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-19
- **链接：** [摘要](https://arxiv.org/abs/2607.17424) · [PDF](https://arxiv.org/pdf/2607.17424v1)
...
## 2. Cosmological simulations of the high-redshift galaxy population adopting a variable stellar initial mass function

- **相关度：** 11
- **匹配词：** JWST, galaxy, galaxies, high redshift, star formation, stellar mass
- **作者：** Anna Durrant, Robert A. Crain, Cedric G. Lacey, Joop Schaye, Renske Smit, Andrea Gebek, Matthieu Schaller, Shengdong Lu, Evgenii Chaikin, Nick Andreadis, Maarten Baes, Matthew R. Bate, Alejandro Benítez-Llambay, Carlos S. Frenk, Filip Huško, Robert J. McGibbon, Sylvia Ploeckinger, Alexander J. Richings
- **分类：** astro-ph.GA
- **首次提交：** 2026-07-17
- **链接：** [摘要](https://arxiv.org/abs/2607.16404) · [PDF](https://arxiv.org/pdf/2607.16404v1)
