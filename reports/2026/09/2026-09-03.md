# JWST × Galaxy arXiv Daily — 2026-09-03

发现 **6** 篇未推送过的相关论文。

## 1. JWST Reveals a Candidate Supermassive Black Hole Binary at z=4.3 in the Brightest Sub-millimeter Galaxy in COSMOS-Web

- **相关度：** 11
- **匹配词：** JWST, COSMOS, COSMOS-Web, NIRCam, NIRSpec, galaxy, galaxies, extragalactic, stellar population, active galactic nucleus, AGN, quiescent, dust attenuation, morphology
- **作者：** Jed McKinney, Ansh Gupta, Julian B. Munoz, John Chisholm, Caitlin M. Casey, Stephanie M. Urbano Stawinski, Olivia Cooper, Erini Lambrides, Hollis Akins, Maximilien Franco, Archana Aravindan, Seiji Fujimoto, Kohei Inayoshi, Andreas L. Faisst, Jeyhan S. Kartaltepe, Michael Boylan-Kolchin
- **分类：** astro-ph.GA, astro-ph.CO
- **首次提交：** 2026-09-01
- **链接：** [摘要](https://arxiv.org/abs/2609.01711) · [PDF](https://arxiv.org/pdf/2609.01711v1)
...
## 4. The GOGREEN Survey: AI Powered Deconvolution Lifts The Veil on Outside-in Environmental Quenching at z &gt; 1

- **相关度：** 7
- **匹配词：** JWST, galaxies, high redshift, star formation, stellar mass, quiescent
- **作者：** Aurelien Henry, Gillian Wilson, Gregory Rudnick, Pascale Jablonka, Utsav Akhaury, Craig Brooks, Michael Balogh, Ben Forrest, Adam Muzzin, Visal Sok, Mohamed H. Abdullah, M. E. Wisz, Elias Works
- **分类：** astro-ph.GA
- **首次提交：** 2026-09-01
- **链接：** [摘要](https://arxiv.org/abs/2609.01903) · [PDF](https://arxiv.org/pdf/2609.01903v1)
...
## 5. The Intermediate-Mass Black Hole Reverberation Mapping Project: Scientific Overview and Sample Characteristics

- **相关度：** 5
- **匹配词：** James Webb Space Telescope, galaxy, galaxies, high redshift
- **作者：** Hengxiao Guo, Jiancheng Wu, Wenwen Zuo, Ruining Tian, Xuechen Zheng, Meicun Hou, Paulina Lira, Philip G. Edwards, Vivian U, Shu Wang, Mar Mezcua, Luis C. Ho, Minfeng Gu, Tao An, Samuzal Barua, Colin J. Burke, Zhen-yi Cai, Xuheng Ding, Haicheng Feng, Alok C. Gupta, ShaSha Li, Wanling Liu, Wen-juan Liu, Ru-sen Lu, Dragana Ilić, Andjelka B. Kovačević, Yu Pan, Luka Č. Popović, Wenke Ren, Paula Sánchez-Sáez, Jamie Stevens, Jingbo Sun, Mouyuan Sun, Chizhuo Wang, Junxian Wang, Rongfeng Shen, Xuebing Wu, Yong Shi, Zhefu Yu, Zhenya Zheng, Ling Zhu
- **分类：** astro-ph.GA
- **首次提交：** 2026-09-02
- **链接：** [摘要](https://arxiv.org/abs/2609.02179) · [PDF](https://arxiv.org/pdf/2609.02179v1)
...
## 6. EWOCS-IX: JWST/NIRCam observations of Westerlund 2 - Identification of candidate substellar members

- **相关度：** 5
- **匹配词：** JWST, NIRCam, spectral energy distribution
- **作者：** V. Almendros-Abad, M. G. Guarcello, K. Muzic, A. Scholz, M. Andersen, A. Bayo, W. Best, D. Capela, M. Gennaro, A. Ginsburg, J. B. Lovell, K. Monsch, E. Moraux, L. Prisinzano, T. Rom, E. Sabbi, P. Zeidler, C. Argiroffi, R. Bonito, D. Calzetti, V. Cusimano, F. Damiani, J. J. Drake, T. J. Haworth, N. D. Richardson, M. Robberto, S. Sciortino, N. J. Wright, T. Ziliotto
- **分类：** astro-ph.GA, astro-ph.SR
- **首次提交：** 2026-09-01
- **链接：** [摘要](https://arxiv.org/abs/2609.01880) · [PDF](https://arxiv.org/pdf/2609.01880v1)
