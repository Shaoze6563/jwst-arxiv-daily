# JWST × Galaxy arXiv Daily — 2026-08-31

发现 **5** 篇未推送过的相关论文。

## 1. Dust and PAHs in late-stage galaxy evolution: Imprints of TP-AGB dust injection, grain growth and AGN feedback in high-z quiescent galaxies with JWST and ALMA

- **相关度：** 15
- **匹配词：** JWST, MIRI, galaxy, galaxies, high-z, AGN, quiescent, star formation, stellar population
- **作者：** D. Donevski, A. Nanni, K. E. Whitaker, A. W. S. Man, A. Faisst, A. Lapi, I. García-Bernette, M. Romano, T. Petrushevska, G. Gururajan, G. Lorenzon, D. Narayanan
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-27
- **链接：** [摘要](https://arxiv.org/abs/2608.27571) · [PDF](https://arxiv.org/pdf/2608.27571v1)
...
## 2. Resolved Dust in $z\approx1$ Galaxies with JWST/MIRI MRS: Survey Description and First View on PAHs, Mid-IR Atomic Emission, and Warm H$_2$

- **相关度：** 11
- **匹配词：** JWST, MIRI, galaxies, star formation, stellar mass, AGN
- **作者：** Wuji Wang, Andreas L. Faisst, Thomas S. -Y. Lai, Kyle Finner, Jed McKinney, Andrew J. Battisti, Irene Shivaei, Leindert A. Boogaard, Daizhong Liu, Yu-Heng Lin, Lun-Jun Liu, Georgios Magdis, Vincenzo Mainieri, Alexander Rodriguez, John D. Silverman, Zhaoxuan Liu, Minju M. Lee, Ghassem Gozaliasl, Maximilien Franco
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-27
- **链接：** [摘要](https://arxiv.org/abs/2608.27560) · [PDF](https://arxiv.org/pdf/2608.27560v1)
...
## 3. Follow-up of SN 2025wny I: Space-based Observations of the First Multiply-imaged Superluminous Supernova

- **相关度：** 6
- **匹配词：** JWST, James Webb Space Telescope, galaxy, galaxies, star formation, spectral energy distribution
- **作者：** Ariel Goobar, Joel Johansson, Edvard Mörtsell, Cameron Lemon, Steve Schulze, Suhail Dhawan, Alice Townsend, Maggie L. Li, Yu-Jing Qin, Lin Yan, Christoffer Fremling, Mansi M. Kasliwal, Peter Nugent, Graham P. Smith, Jesper Sollerman, Igor Andreoni, Nikki Arendse, Thomas E. Collett, Jakob Nordin, Jacob Osman Hjortlund, Daniel A. Perley, Mickael Rigault, Stephen Thorp, Jacob L. Wise
- **分类：** astro-ph.CO
- **首次提交：** 2026-08-28
- **链接：** [摘要](https://arxiv.org/abs/2608.28413) · [PDF](https://arxiv.org/pdf/2608.28413v1)
...
## 4. A Clearer View of HAT-P-1 b: JWST NIRSpec G395H Reveals Water, Carbon Dioxide, and Possibly Hydrogen Sulfide

- **相关度：** 5
- **匹配词：** JWST, NIRSpec, metallicity
- **作者：** Reza Ashtari, Stephen P. Schmidt, Guangwei Fu, Avinash Verma, David K. Sing, Kevin B. Stevenson, Jayesh Goyal, Katherine A. Bennett, Joshua D. Lothringer, Jacob Lustig-Yaeger, Sagnick Mukherjee, Carlos Gascón, Natalie H. Allen, Patrick McCreery, Le-Chris Wang, Mei Ting Mak, Kristin S. Sotzen, Lakeisha M. Ramos Rosado, N. J. Mayne
- **分类：** astro-ph.EP
- **首次提交：** 2026-08-28
- **链接：** [摘要](https://arxiv.org/abs/2608.28538) · [PDF](https://arxiv.org/pdf/2608.28538v1)
...
## 5. Formation of black hole stars via star--black hole collisions

- **相关度：** 5
- **匹配词：** JWST, high redshift, stellar mass, active galactic nucleus, AGN
- **作者：** Yanlong Shi, Qingru Hu, Zhenghao Xu, Douglas N. C. Lin, Norman Murray
- **分类：** astro-ph.HE, astro-ph.GA, astro-ph.SR
- **首次提交：** 2026-08-27
- **链接：** [摘要](https://arxiv.org/abs/2608.27596) · [PDF](https://arxiv.org/pdf/2608.27596v1)
