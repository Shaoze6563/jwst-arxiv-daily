# JWST × Galaxy arXiv Daily — 2026-08-11

发现 **8** 篇未推送过的相关论文。

## 1. JWST Reveals a Galaxy-Wide Association of Red Supergiants with OB Stars in NGC 5584

- **相关度：** 10
- **匹配词：** JWST, NIRCam, galaxy, star formation, morphology
- **作者：** Min Dai, Shu Wang, Biwei Jiang
- **分类：** astro-ph.SR, astro-ph.GA
- **首次提交：** 2026-08-08
- **链接：** [摘要](https://arxiv.org/abs/2608.08006) · [PDF](https://arxiv.org/pdf/2608.08006v1)
...
## 2. An emerging baryon cycle in a galaxy 500 million years after the Big Bang

- **相关度：** 9
- **匹配词：** JWST, galaxy, galaxies, high redshift, reionization, star formation, stellar mass
- **作者：** Shengzhe Wang, Xin Wang, Hang Zhou, Zhijie Qu, Zhaozhou Li, Yuxuan Pang, Qianqiao Zhou, Shouyi Wang, Yangyao Chen, Yuguang Chen, Karl Glazebrook, Glenn G. Kacprzak, Nicha Leethochawalit, Houjun Mo, Themiya Nanayakkara, Huiyuan Wang, Weida Hu, Xunda Sun, Chao-Wei Tsai, Hu Zhan
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-10
- **链接：** [摘要](https://arxiv.org/abs/2608.09813) · [PDF](https://arxiv.org/pdf/2608.09813v1)
...
## 3. A New Window on the Hα Luminosity Function and Star Formation Rate Density from 1.2 &lt; z &lt; 6.6 from JWST Medium-Band Photometry

- **相关度：** 9
- **匹配词：** JWST, James Webb Space Telescope, NIRCam, star formation, reionization, emission line, spectral energy distribution, dust attenuation
- **作者：** Nicholas S. Martis, Chris Willott, Gregor Rihtaršič, Vesna Pirc Jevšenak, Roberto Abraham, Yoshihisa Asada, Maruša Bradač, Gabriel Brammer, Guillaume Desprez, Vicente Estrada-Carpenter, Kartheik Iyer, Lamiya Mowla, Adam Muzzin, Gaël Noirot, Ghassan T. E. Sarrouh, Marcin Sawicki, Sunna Withers, Giordano Felicioni, Jon Judež, Danilo Marchesini, Vladan Markov, Katherine Myers, Luke Robbins, Visal Sok, Wren Suess, Roberta Tripodi
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-08
- **链接：** [摘要](https://arxiv.org/abs/2608.08203) · [PDF](https://arxiv.org/pdf/2608.08203v1)
...
## 4. First Light and Assembly of GalaxieS (FLAGS) I: The JWST/NIRCam Number Counts and IGL as Constraints on Galaxy Formation Models

- **相关度：** 9
- **匹配词：** JWST, NIRCam, galaxy, galaxies, SED fitting
- **作者：** Jack C. Turner, Stephen M. Wilkins, Aswin P. Vijayan
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-07
- **链接：** [摘要](https://arxiv.org/abs/2608.07668) · [PDF](https://arxiv.org/pdf/2608.07668v1)
...
## 5. GATOS: Distinct Feedback Modes in AGN Central Regions Revealed by Spatially Resolved JWST Spectroscopy

- **相关度：** 8
- **匹配词：** JWST, MIRI, AGN, star formation
...
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-08
- **链接：** [摘要](https://arxiv.org/abs/2608.08369) · [PDF](https://arxiv.org/pdf/2608.08369v1)
...
## 6. IPA: Morphology and Kinematics of Molecular Hydrogen Winds in Five Young Protostars across the Mass Spectrum Observed with JWST

- **相关度：** 7
- **匹配词：** JWST, NIRSpec, MIRI, morphology
...
- **首次提交：** 2026-08-10
- **链接：** [摘要](https://arxiv.org/abs/2608.09920) · [PDF](https://arxiv.org/pdf/2608.09920v1)
...
## 7. Dust production in the harsh environment of Sgr A* - MIRI/JWST observation of the O-rich asymptotic giant branch star IRS~3

- **相关度：** 6
- **匹配词：** JWST, MIRI, James Webb Space Telescope, galaxy
- **作者：** F. Peißker, M. García Marín, A. Eckart, G. Wright, O. C. Jones, D. Dicken, A. Alonso Herrero, D. Rouan, D. Law, T. Böker, T. Henning, M. Baes, A. Labiano, L. Pantoni, L. Hermosa Muñoz, P. O. Lagage, P. van der Werf, G. Östlin, J. A. D. L. Blommaert, M. Güdel, P. Guillard
- **分类：** astro-ph.GA, astro-ph.SR
- **首次提交：** 2026-08-10
- **链接：** [摘要](https://arxiv.org/abs/2608.09511) · [PDF](https://arxiv.org/pdf/2608.09511v1)
