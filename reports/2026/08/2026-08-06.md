# JWST × Galaxy arXiv Daily — 2026-08-06
...
- **相关度：** 10
- **匹配词：** COSMOS, extragalactic, galaxy, galaxies, stellar mass, morphology
- **作者：** Seoyoung Lyla Jung, Madalina N. Tudorache, Matt J. Jarvis, Michalina Maksymowicz-Maciata, Maarten Baes, Marcin Glowacki, Natasha Maddox, Anastasia A. Ponomareva, Kristine Spekkens, Tariq Yasin, Bohan Yue
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-05
- **链接：** [摘要](https://arxiv.org/abs/2608.04656) · [PDF](https://arxiv.org/pdf/2608.04656v1)
...
## 2. JWST Transmission Spectroscopy of TOI-3235 b: Challenges in Constraining Giant Planet Atmospheres Around M Dwarfs Amid Stellar Contamination

- **相关度：** 5
- **匹配词：** JWST, NIRSpec, metallicity
- **作者：** Zoe Ko, Néstor Espinoza, Andrés Jordán, Daniel Bayliss, Edward M. Bryant, Martin Schlecker, Melissa J. Hobson, Rafael Brahm, Remo Burn, Thomas Henning
- **分类：** astro-ph.EP
- **首次提交：** 2026-08-04
- **链接：** [摘要](https://arxiv.org/abs/2608.04194) · [PDF](https://arxiv.org/pdf/2608.04194v1)
...
## 3. Implications of Broad [O III] 4364 and UV Line Emission in Two Little Red Dots at z ~ 7 - 8

- **相关度：** 5
- **匹配词：** NIRSpec, galaxies, star formation
- **作者：** Casey Papovich, Kaila Ronayne, Weida Hu, Dale D. Kocevski, Pablo Arrabal Haro, Taylor A. Hutchison, Steven L. Finkelstein, Erini Lambrides, Rebecca L. Larson, Bren E. Backhaus, Micaela B. Bagley, Nikko J. Cleri, Mark Dickinson, Ray Garner, Jeyhan Kartaltepe, Vasily Kokorev, Grace M. Olivier, Anthony J. Taylor, Jonathan R. Trump, Jiayang Yang
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-04
- **链接：** [摘要](https://arxiv.org/abs/2608.04101) · [PDF](https://arxiv.org/pdf/2608.04101v1)
