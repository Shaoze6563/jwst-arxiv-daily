# JWST × Galaxy arXiv Daily — 2026-08-24

发现 **2** 篇未推送过的相关论文。

## 1. Pandora cluster Lensing, AGN, and Transient Exploration (PLATE) from JWST Multi-Epoch Imaging. I. Discovery of a type II supernova candidate in a spiral galaxy at $z=0.7$

- **相关度：** 13
- **匹配词：** JWST, NIRCam, galaxy, AGN, star formation, stellar mass
- **作者：** Yuxuan Pang, Xin Wang, Ping Chen, Subo Dong, Hang Zhou, Shengzhe Wang, Qianqiao Zhou, Xunda Sun, Jifeng Liu, Hu Zhan, Karl Glazebrook, Ivo Labbé, Themiya Nanayakkara, David A. Coulter, Justin D. R. Pierel, Armin Rest, Jujia Zhang
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-21
- **链接：** [摘要](https://arxiv.org/abs/2608.20781) · [PDF](https://arxiv.org/pdf/2608.20781v1)
...
## 2. Mapping the z&gt;=5 SiIV Column Density Distribution onto the Galaxy Stellar Mass Function Using the Cumulative Absorption Cross Section

- **相关度：** 9
- **匹配词：** JWST, galaxy, galaxies, stellar mass
- **作者：** Kristian Finlator, Sam Patterson, Nora Nava, Ayanah Cason, Samir Kušmić, Ezra Huscher, Farhanul Hasan
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-20
- **链接：** [摘要](https://arxiv.org/abs/2608.20609) · [PDF](https://arxiv.org/pdf/2608.20609v1)
