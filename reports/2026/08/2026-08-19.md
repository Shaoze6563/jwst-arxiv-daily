# JWST × Galaxy arXiv Daily — 2026-08-19

发现 **3** 篇未推送过的相关论文。

## 1. Diverse ionized gas conditions in a dynamically hot, interacting galaxy at $z = 9.31$ revealed by JWST/NIRSpec IFU

- **相关度：** 10
- **匹配词：** JWST, NIRSpec, James Webb Space Telescope, galaxy, star formation, metallicity
- **作者：** Ryota Ikeda, Takahiro Morishita, Massimo Stiavelli, Antonello Calabrò
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-17
- **链接：** [摘要](https://arxiv.org/abs/2608.16996) · [PDF](https://arxiv.org/pdf/2608.16996v1)
...
## 2. The Stellar Population of NGC 346 in the Small Magellanic Cloud with JWST

- **相关度：** 9
- **匹配词：** JWST, NIRCam, MIRI, stellar population, star formation, metallicity
- **作者：** J. Jaspers, P. Kavanagh, G. De Marchi, C. Nally, O. Jones, N. Habel, P. Zeidler, M. Meixner, E. Sabbi, A. Hirschauer, K. Biazzo, L. Lenkic, O. Nayak, M. Roberto, C. Rogers, B. Sargent
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-18
- **链接：** [摘要](https://arxiv.org/abs/2608.17875) · [PDF](https://arxiv.org/pdf/2608.17875v1)
...
## 3. GEMS JWST: Hold on to your HATS(-6 b), a sub-solar metallicity giant planet with water, methane and ammonia in its atmosphere

- **相关度：** 7
- **匹配词：** JWST, NIRSpec, metallicity
- **作者：** Giannina Guzmán Caloca, Caleb I. Cañas, Nicole L. Wallack, Erin M. May, Shang-Min Tsai, Simon Müller, Ravit Helled, Shubham Kanodia, Jacob Lustig-Yaeger, Knicole D. Colón, Ian Czekala, Megan Delamer, Peter Gao, Te Han, Jessica Libby-Roberts, Suvrath Mahadevan, Anjali A. A. Piette, Guðmundur Stefánsson, Kevin B. Stevenson
- **分类：** astro-ph.EP
- **首次提交：** 2026-08-17
- **链接：** [摘要](https://arxiv.org/abs/2608.16990) · [PDF](https://arxiv.org/pdf/2608.16990v1)
