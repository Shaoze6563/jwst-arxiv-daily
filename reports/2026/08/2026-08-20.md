# JWST × Galaxy arXiv Daily — 2026-08-20

发现 **2** 篇未推送过的相关论文。

## 1. The progenitors of $z\gtrsim10$ JWST galaxies in the COLIBRE simulations

- **相关度：** 10
- **匹配词：** JWST, galaxies, galaxy, high redshift, star formation
- **作者：** Evgenii Chaikin, Andrew Pontzen, Carlos S. Frenk, Joop Schaye, Shengdong Lu, Robert A. Crain, Anna Durrant
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-19
- **链接：** [摘要](https://arxiv.org/abs/2608.19007) · [PDF](https://arxiv.org/pdf/2608.19007v1)
