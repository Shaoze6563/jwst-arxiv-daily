# JWST × Galaxy arXiv Daily — 2026-08-25
...
- **相关度：** 10
- **匹配词：** JWST, galaxies, galaxy, high redshift, stellar mass
- **作者：** Xu Zhao, Carlos S. Frenk, Andrew Pontzen, Kyle A. Oman, Evgenii Chaikin, Isabel Santos-Santos, Shengdong Lu, Joop Schaye, Alejandro Benítez-Llambay, Filip Huško, Alexander J. Richings, Matthieu Schaller
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-24
- **链接：** [摘要](https://arxiv.org/abs/2608.23558) · [PDF](https://arxiv.org/pdf/2608.23558v1)
...
## 2. On the importance of the IGM/CGM enrichment in determining chemical abundances during the first 600 Myr

- **相关度：** 7
- **匹配词：** JWST, CEERS, galaxies, high redshift, star formation, metallicity
- **作者：** Annalisa Citro, Yong-Zhong Qian, Claudia Scarlata
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-21
- **链接：** [摘要](https://arxiv.org/abs/2608.21515) · [PDF](https://arxiv.org/pdf/2608.21515v1)
...
## 3. Indirect evidence of the $2175\,\mathring{\mathrm{A}}$ extinction bump within the dusty torus of SDSS J141945.50+524648.0

- **相关度：** 5
- **匹配词：** JWST, NIRCam, galaxy, AGN
- **作者：** Ze Li, Gaoyang Chen, Qifan Cui, Zheng Cai, Jianzhen Chen, Zhijian Luo, Chenggang Shu, Fengwu Sun, Hubing Xiao, Shaohua Zhang
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-22
- **链接：** [摘要](https://arxiv.org/abs/2608.21876) · [PDF](https://arxiv.org/pdf/2608.21876v1)
