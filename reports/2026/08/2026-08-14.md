# JWST × Galaxy arXiv Daily — 2026-08-14

发现 **9** 篇未推送过的相关论文。

## 1. A cosmic collision in the making: JWST/NIRISS reveals a merging and maturing protocluster core at z~3 around a red quasar

- **相关度：** 11
- **匹配词：** JWST, galaxy, galaxies, protocluster, star formation, AGN, quiescent
- **作者：** C. Bertemes, D. Wylezalek, G. Noirot, R. Hviding, D. S. N. Rupke, N. L. Zakamska, S. Veilleux, L. Gatto, W. Liu, A. Vayner, Y. Ishikawa, Y. Chen, S. Sankar
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-10
- **链接：** [摘要](https://arxiv.org/abs/2608.10070) · [PDF](https://arxiv.org/pdf/2608.10070v1)
...
- **相关度：** 11
- **匹配词：** JWST, James Webb Space Telescope, NIRSpec, galaxies, high redshift, star formation, metallicity
- **作者：** Raunaq Singh Rai, Guido Roberts-Borsani
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-10
- **链接：** [摘要](https://arxiv.org/abs/2608.10063) · [PDF](https://arxiv.org/pdf/2608.10063v1)
...
## 3. ALMA observations of pre-JWST z ~ 10 galaxy candidates: A CO(J = 9-8) line from a ULIRG at z = 2.54 and revisit of the photometric redshifts with JWST photometry

- **相关度：** 9
- **匹配词：** JWST, James Webb Space Telescope, NIRCam, NIRSpec, galaxy, galaxies, spectral energy distribution
- **作者：** Suzuka Arai, Yuma Sugahara, Akio K. Inoue, Takuya Hashimoto, Ken Mawatari, Yi W. Ren, Steven L. Finkelstein, John R. Weaver, Rebecca L. Larson, Seiji Fujimoto, Yuichi Harikane, Takahiro Morishita, Yoichi Tamura, Andreas Faisst, Charles Steinhardt, Nima Chartab, Larry D. Bradley, David B. Sanders
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-13
- **链接：** [摘要](https://arxiv.org/abs/2608.12708) · [PDF](https://arxiv.org/pdf/2608.12708v1)
...
## 4. The Ĝ Infrared Search for Extraterrestrial Civilizations with Large Energy Supplies. V. When Galaxies Glow with Industry

- **相关度：** 9
- **匹配词：** JWST, galaxies, galaxy, stellar population, AGN, spectral energy distribution, quiescent
- **作者：** Olivia Curtis, Aidan J. Rowland, Jason T. Wright, Caryl Gronwall, Jakob M. Helton, Joel Leja
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-12
- **链接：** [摘要](https://arxiv.org/abs/2608.12458) · [PDF](https://arxiv.org/pdf/2608.12458v1)
...
## 5. SPURS: Massive Stars, Dense Gas, and Ly$α$ Escape in GN-z11 at $z = 10.6$

- **相关度：** 7
- **匹配词：** JWST, galaxy, star formation, stellar population, AGN, metallicity
- **作者：** Zuyi Chen, Daniel P. Stark, Charlotte A. Mason, Peter Senchyna, Mengtao Tang, Keerthi Vasan G. C., Lily Whitler, Adele Plat, Viola Gelli
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-13
- **链接：** [摘要](https://arxiv.org/abs/2608.12699) · [PDF](https://arxiv.org/pdf/2608.12699v1)
...
## 6. FLAGS II: Constraining Galaxy Formation Models with Dimensionality Reduction of Direct Observables

- **相关度：** 7
- **匹配词：** JWST, galaxy, galaxies, SED fitting
- **作者：** Jack C. Turner, Stephen M. Wilkins, William J. Roper, Aswin P. Vijayan
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-12
- **链接：** [摘要](https://arxiv.org/abs/2608.12471) · [PDF](https://arxiv.org/pdf/2608.12471v1)
...
## 7. Ripples in the OCEANS: Broad Line Variability of Little Red Dots

- **相关度：** 6
- **匹配词：** JWST, CEERS, extragalactic, active galactic nucleus, AGN
- **作者：** Madisyn Brooks, Kelcey Davis, Jonathan R. Trump, Raymond C. Simons, Erini Lambrides, Pablo Arrabal Haro, Bren E. Backhaus, Nikko J. Cleri, Steven L. Finkelstein, Mauro Giavalisco, Norman A. Grogin, Michaela Hirschmann, Dale D. Kocevski, Anton M. Koekemoer, Rebecca L. Larson, Ray A. Lucas, Stephen M. Wilkins, Stijn Wuyts, Jorge A. Zavala
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-12
- **链接：** [摘要](https://arxiv.org/abs/2608.12487) · [PDF](https://arxiv.org/pdf/2608.12487v1)
...
## 8. Why is GN-z11 Bright, Compact, and Nitrogen Enhanced? Insights from UV Absorption and Emission Diagnostics

- **相关度：** 5
- **匹配词：** JWST, NIRSpec, JADES, galaxy, AGN
- **作者：** Minami Nakane, Masami Ouchi
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-12
- **链接：** [摘要](https://arxiv.org/abs/2608.12466) · [PDF](https://arxiv.org/pdf/2608.12466v1)
...
## 9. Testing Covarying Coupling Constants (CCC) against the full SPARC rotation-curve sample: a like-for-like comparison with MOND and NFW

- **相关度：** 5
- **匹配词：** JWST, galaxy, galaxies, high redshift
- **作者：** Rajendra P. Gupta, Nikolaos Samaras
- **分类：** astro-ph.GA
- **首次提交：** 2026-08-12
- **链接：** [摘要](https://arxiv.org/abs/2608.11575) · [PDF](https://arxiv.org/pdf/2608.11575v1)
